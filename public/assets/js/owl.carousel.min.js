    ...
    var i = {
        ...
        for (n.positionsInArray = [0], n.pagesInArray = [], e = 0; e < n.itemsAmount; e += 1)
          (a += n.itemWidth),
            ...
            n.options.scrollPerPage === !0 &&
              ...
              i !== s && ((n.pagesInArray[s] = n.positionsInArray[e]), (s = i)))
      },
      ...
      updateControls: function () {
        ...
        t.updatePagination(),
          t.checkNavigation(),
          t.owlControls &&
            (t.options.items >= t.itemsAmount ? t.owlControls.hide() : t.owlControls.show())
      },
      ...
      next: function (t) {
        ...
        if (
          ...
          e.currentItem >
            e.maximumItem + (e.options.scrollPerPage === !0 ? e.options.items - 1 : 0))
        ) {
      ...
      gestures: function () {
        ...
        function n(e) {
          'on' === e
            ...
            : 'off' === e && (t(o).off(l.ev_types.move), t(o).off(l.ev_types.end))
        }
        function s(o) {
          var s,
        ...
        function a(n) {
          ...
          ;(l.newPosX = i(r).x - p.offsetX),
            ...
            (l.newRelativeX > 8 || l.newRelativeX < -8) &&
              l.browser.isTouch === !0 &&
              (void 0 !== r.preventDefault ? r.preventDefault() : (r.returnValue = !1),
              (p.sliding = !0)),
            ...
            'loaded' !== o.data('owl-loaded') &&
              ...
              'string' == typeof n.data('src')
                ? (void 0 === o.data('owl-loaded') &&
                    (n.hide(), o.addClass('loading').data('owl-loaded', 'checked')),
      ...
      completeImg: function (t) {
        var e
        return t.complete
          ? ((e = typeof t.naturalWidth), 'undefined' !== e && 0 === t.naturalWidth ? !1 : !0)
          : !1
      },
